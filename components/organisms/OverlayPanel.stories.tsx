  ...
  args: {
    children: (
      <div className="px-2 py-6">
        <p className="sk-text-sm-regular text-sko-text-subtle">Body content goes here.</p>
      </div>
    ),
  },
};
    ...
    children: (
      <>
        ...
        <div className="px-2 py-3">
          <p className="sk-text-sm-regular text-sko-text-muted">An item in section A.</p>
        </div>
      </>
    ),
  },
...
export const WithFooter: Story = {
  args: {
    ...
    children: (
      <div className="px-2 py-3">
        <p className="sk-text-sm-regular text-sko-text-muted">Scrollable body with a footer link below.</p>
      </div>
    ),
  },
};
